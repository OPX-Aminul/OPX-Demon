package com.opx.demon.terminal.frontend.floating
...
import com.opx.demon.terminal.component.session.ShellTermSession
import com.opx.demon.terminal.frontend.session.terminal.BasicSessionCallback
import com.opx.demon.terminal.frontend.session.terminal.BasicViewClient
...
class WindowTermView(val context: Context) {
  ...
  fun setTerminalViewClient(terminalViewClient: com.opx.demon.terminal.frontend.session.view.TerminalViewClient?) {
