package com.opx.demon.terminal.ui.settings
...
import com.opx.demon.terminal.ui.customize.CustomizeActivity
...
class SettingsHomeFragment : Fragment() {
  ...
  override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
    ...
    view.findViewById<View>(R.id.row_github).setOnClickListener {
      runCatching {
        startActivity(Intent(Intent.ACTION_VIEW, Uri.parse("https://github.com/OPX-Aminul/OPX-Demon")))
      }
    }
  }
}
