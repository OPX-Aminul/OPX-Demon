package com.opx.demon.terminal.framework.database;

import com.opx.demon.terminal.framework.database.annotation.Ignore;
import com.opx.demon.terminal.framework.database.annotation.NotNull;
