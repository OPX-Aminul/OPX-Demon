...
import com.opx.demon.terminal.component.NeoInitializer
import com.opx.demon.terminal.component.config.NeoPreference
import com.opx.demon.terminal.ui.other.BonusActivity
...
open class App : Application() {
  ...
  fun openHelpLink() {
    val intent = Intent(Intent.ACTION_VIEW, Uri.parse("https://github.com/OPX-Aminul/OPX-Demon"))
