...
public class Logger {
    ...
    public void generateNmapReport(String ip, ArrayList<String> output) {
        ...
        @SuppressLint("SdCardPath") String path = "/data/data/com.opx.demon/files/reports/";
        ...
        try {
            ...
            fOut.flush();
            editor.close();
            customCommand("su -c 'cp " + path + filename + " /sdcard/OPX-Demon/reports/'");
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
