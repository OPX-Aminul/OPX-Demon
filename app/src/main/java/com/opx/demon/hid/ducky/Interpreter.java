package com.opx.demon.hid.ducky;

import androidx.annotation.NonNull;
import androidx.annotation.Nullable;

import com.opx.demon.hid.backchannel.AcmChannel;
import com.opx.demon.hid.keymap.KeyEntry;
...
import com.opx.demon.hid.report.MouseReport;
...
public final class Interpreter {
    ...
    private void typeString(@NonNull Step.TypeString step) throws IOException, InterruptedException {
        ...
        if (step.trailingEnter) {
            keyboard.sendKey(KeyReport.singleKey(0, com.opx.demon.hid.report.UsbHid.KEY_ENTER));
            releaseIfNotHeld();
        }
    }
