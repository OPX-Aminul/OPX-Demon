...
import com.opx.demon.hid.capability.HidCapabilities;
import com.opx.demon.hid.capability.HidCapabilityProbe;
import com.opx.demon.hid.configfs.GadgetFunction;
import com.opx.demon.hid.configfs.GadgetProfile;
import com.opx.demon.hid.configfs.UsbGadgetController;
import com.opx.demon.hid.ducky.Program;
import com.opx.demon.hid.ducky.Step;
import com.opx.demon.hid.exec.ExecutionResult;
import com.opx.demon.hid.exec.HidExecutor;
import com.opx.demon.hid.keymap.KeymapRegistry;
import com.opx.demon.hid.payload.PayloadLibrary;
import com.opx.demon.hid.ui.editor.DuckySyntaxHighlighter;
import com.opx.demon.hid.ui.editor.LinedEditText;
import com.opx.demon.hid.ui.editor.LiveSyntaxValidator;
import com.opx.demon.hid.ui.editor.PayloadFileIo;
import com.opx.demon.usbarsenal.GadgetProfileDb;
    ...
    private final HidExecutor.ProgressSink sink = new HidExecutor.ProgressSink() {
        ...
        public void onOpenViewer(@NonNull Step step) {
            ...
            Intent i = new Intent(HidIdeActivity.this,
                    com.opx.demon.hid.backchannel.ScreenViewerActivity.class);
