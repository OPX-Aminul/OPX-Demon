...
public final class DuckyParser {
    ...
    private int parseMouseButton(String body, int line) throws DuckyParseException {
        switch (body.trim().toUpperCase(Locale.ROOT)) {
            case "":
            case "LEFT":   return com.opx.demon.hid.report.MouseReport.BTN_LEFT;
            case "RIGHT":  return com.opx.demon.hid.report.MouseReport.BTN_RIGHT;
            case "MIDDLE": return com.opx.demon.hid.report.MouseReport.BTN_MIDDLE;
            default:
