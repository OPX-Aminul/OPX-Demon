package com.opx.demon.localnetwork.utils;
...
import com.opx.demon.custom.Port;
import com.opx.demon.localnetwork.nonroot.NonRootScanner;
    ...
    public ArrayList<Device> localDevices(ArrayList<String> output) {
        ...
        for (int i = 0; i < output.size(); i++) {
            ...
            if (temp.contains("Nmap scan report for ")) {
                ...
                String vendor = com.opx.demon.localnetwork.utils.MacLine.vendorOf(temp);
