...
public final class HydraEngine {
    ...
    private String buildCommand(Spec spec) {
        ...
        if (needLogin) {
            if (notEmpty(spec.singleLogin)) {
                ...
                cmd.append("-L /sdcard/OPX-Demon/wordlists/").append(spec.loginWordlist).append(' ');
            }
        }
        if (notEmpty(spec.singlePassword)) {
            ...
            cmd.append("-P /sdcard/OPX-Demon/wordlists/").append(spec.passwordWordlist).append(' ');
        }
    ...
    private void openTranscript(Spec spec) {
        try {
            File dir = new File("/sdcard/OPX-Demon/hydra");
            dir.mkdirs();
