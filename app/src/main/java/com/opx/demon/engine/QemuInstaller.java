...
import com.opx.demon.ota.QemuDownloader;
...
public final class QemuInstaller {
    ...
    private static boolean fetchIfNeeded(com.opx.demon.ota.RemoteManifest.Asset asset, File dest,
    ...
    private static boolean fetch(com.opx.demon.ota.RemoteManifest.Asset asset, File dest,
        ...
        com.opx.demon.ota.VerifiedDownloader.Result r =
                com.opx.demon.ota.VerifiedDownloader.download(
    ...
    private static void ensureMinimumDisk(Context context, Progress p) {
        try {
            ...
            com.opx.demon.utils.Core core = new com.opx.demon.utils.Core(context);
