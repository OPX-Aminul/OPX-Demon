...
public final class GuestExec {
    ...
    private static final String EXIT_SENTINEL = "__OPX_DEMON_EXIT__";
    private static final String JOB_EOF = "__OPX_DEMON_JOB_EOF__";
    ...
    private static final String PING_MARK = "__OPX_DEMON_PONG__";
