package com.opx.demon.settings;
...
import com.opx.demon.logger.LoggerFragment;
import com.opx.demon.metasploit.utils.MetasploitUtils;
import com.opx.demon.settings.commands.CustomCommandsWifi;
...
public class SettingsHomeFragment extends Fragment {
    ...
    private void performDelete() {
        ...
        new Thread(() -> {
            ...
            if (!core.safeDeleteTree("/data/local/opxdemon")) {
                ui(() -> {
            ...
            core.customCommand("pm uninstall com.opx.demon");
            ui(() -> {
