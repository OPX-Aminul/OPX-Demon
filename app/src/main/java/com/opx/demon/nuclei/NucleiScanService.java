...
import com.opx.demon.custom.NucleiItem;
import com.opx.demon.custom.Site;
import com.opx.demon.engine.GuestExec;
...
public class NucleiScanService extends Service {
    ...
    public static final String ACTION_CANCEL = "com.opx.demon.nuclei.CANCEL";
    public static final String ACTION_UPDATED = "com.opx.demon.nuclei.UPDATED";
    ...
    private static final String TEMPLATES_MARKER = "__OPX_DEMON_NUCLEI_TEMPLATES__";
    ...
    private java.util.List<String> buildNucleiScript(String target, @Nullable String severityList) {
        ...
        lines.add("if [ ! -f " + com.opx.demon.install.InstallService.NUCLEI_TEMPLATES_MARKER + " ]; then "
