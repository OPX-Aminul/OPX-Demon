...
import com.opx.demon.appintro.install.InstallStage;
import com.opx.demon.appintro.install.LogAdapter;
import com.opx.demon.appintro.install.LogLevel;
import com.opx.demon.appintro.install.LogLine;
import com.opx.demon.engine.Apt;
import com.opx.demon.engine.GuestCore;
import com.opx.demon.ota.CoreDownloader;
import com.opx.demon.ota.RemoteManifest;
import com.opx.demon.ota.VerifiedDownloader;
...
public class Slide3 extends Fragment {
    ...
    private static final String DOWNLOADED_CHROOT_PATH =
            "/data/data/com.opx.demon/files/chroot64-debian.tar.gz";
    ...
    private void startInstall() {
        ...
        if (activity instanceof com.opx.demon.appintro.AppIntroActivity
                && ((com.opx.demon.appintro.AppIntroActivity) activity).isMigration()) {
        ...
        new Thread(() -> {
            ...
            if (downloadChroot(chrootAsset)) {
                ...
                if (unTarFile()) {
                    ...
                    core.deleteFile("/sdcard/OPX-Demon/exploits/");
                    core.copyFile("/data/data/com.opx.demon/files/checker.py",
                            "/data/local/opxdemon/release/exploits/checker.py");
                    core.copyFile("/data/local/opxdemon/release/exploits/", "/sdcard/OPX-Demon/exploits");
                    core.chmodFolder("/data/data/com.opx.demon/files");
                    markStage(InstallStage.DEPLOYING_EXPLOITS, RowState.DONE);
                    log(LogLevel.SUCCESS, "Exploits deployed to /sdcard/OPX-Demon/exploits");
                    ...
                    core.deleteFile("/sdcard/OPX-Demon/exploits/checker.py");
    ...
    private boolean clear() {
        core.chmodFolder("/data/data/com.opx.demon/files/");
        core.createFolder(core.getStorage() + "/OPX-Demon/");
    ...
    private static final String TAR_RC = "__OPX_DEMON_TAR_RC__";
