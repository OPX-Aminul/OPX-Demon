...
import com.opx.demon.appintro.install.LogClassifier;
import com.opx.demon.appintro.install.LogLevel;
import com.opx.demon.appintro.install.LogLine;
import com.opx.demon.vnc.install.VncInstallStage;
...
public class VNCFragment extends Fragment {
    ...
    private boolean stageForGuest() {
        ...
        core.customChrootCommand("mkdir -p " + VNC_DIR + "; "
                + "cp -f /sdcard/OPX-Demon/.opxdemon-vnc/install.sh " + VNC_DIR + "/install.sh; "
                + "cp -f /sdcard/OPX-Demon/.opxdemon-vnc/uninstall.sh " + VNC_DIR + "/uninstall.sh; "
