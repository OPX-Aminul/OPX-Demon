...
public class VNCService extends Service {
    ...
    public static final String ACTION_START = "com.opx.demon.vnc.action.START";
    public static final String ACTION_STOP = "com.opx.demon.vnc.action.STOP";
    public static final String EXTRA_RESOLUTION = "com.opx.demon.vnc.extra.resolution";
    public static final String EXTRA_PORT = "com.opx.demon.vnc.extra.port";
