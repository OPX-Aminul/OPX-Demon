...
public class InstallService extends Service {
    ...
    public static final String ACTION_INSTALL = "com.opx.demon.install.INSTALL";
    public static final String ACTION_CANCEL = "com.opx.demon.install.CANCEL";
    public static final String ACTION_UPDATED = "com.opx.demon.install.UPDATED";
