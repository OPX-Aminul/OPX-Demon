...
# ==============================================================================
# SECTION 0b: arm64 User-Mode-Linux kernel (rootless engine v2, kernel 7.2)
# ==============================================================================
# Reverse-engineered from the original rootless-650 release:
#   • linux-uml : kernel 7.2.0-rc4-g8897487c5223 built as a userspace ELF
#                 (CONFIG_UML=y / CONFIG_UML_ARM64=y / CONFIG_STATIC_LINK=y).
...
# Android NDK r27c — the released config was generated by Android clang 18 / LLD
# (CONFIG_CC_VERSION_TEXT / CONFIG_LD_IS_LLD in build-tools/uml-arm64.config),
# and the binary must run as a userspace process on Android.
...
# arm64 UML kernel (rootless engine v2 — same rootfs boots QEMU and UML)
COPY --from=uml-builder /out/linux-uml /linux-uml
